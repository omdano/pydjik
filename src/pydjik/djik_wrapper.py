...
pydjik.djik.restype = ndmat_i1_type  # Nx2 (i, j) coordinates or None
pydjik.djik.argtypes = [
...
def djik_cost(edges: np.ndarray, goal:int, n:int) -> Optional[np.ndarray]:
    """
    ...
    #"""
    path = pydjik.djik.djik(lengths.flatten().astype(np.intc),
